...
![Version](https://img.shields.io/badge/version-1.8.0--beta-38bdf8) ![Status](https://img.shields.io/badge/status-active-34d399)
...
- **"My Families" member list** (Family Management → Families → a family's detail panel) is the same rich per-person card as Site User Management — name, color, email, role, active/inactive, edit, delete — scoped to that one family, instead of a plain email list.
